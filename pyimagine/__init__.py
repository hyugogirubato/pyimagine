...
class Style(Enum):
    # style_id, asset, suffix
    IMAGINE_BETA_4 = (30, "Imagine_V3.5", None)
    IMAGINE_V3 = (28, "thumbv1_27", ", 4k, high quality, hdr")
    IMAGINE_V1 = (27, "thumbv1_28", None)
    REALISTIC = (29, "thumbv1_29", None)
    ANIME = (21, "thumb_20", None)
...
def _cfg(cfg: float) -> str:
    if cfg < 0.0 or cfg > 16.0:
        raise Exception(f"Error: Invalid CFG, must be in range (0; 16), {cfg}")
    return str(cfg)
